...
<meta charset="utf-8" />
    <link rel="shortcut icon" href="/wp-content/themes/tienda/favicon.ico" />
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/tienda in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/tienda) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/tienda/favicon.ico" will
        work correctly both with client-side routing and a non-root public URL.
        Learn how to configure a non-root public URL by running `npm run wpbuild`.
    -->
    <title>React WordPress Theme</title>
<link href="/wp-content/themes/tienda/static/css/main.chunk.css?e43d2e92c0138121919e" rel="stylesheet"></head>
    <body>
    <noscript>
    ...
    -->
    <script src="/wp-content/themes/tienda/static/js/bundle.js?e43d2e92c0138121919e"></script><script src="/wp-content/themes/tienda/static/js/0.chunk.js?e43d2e92c0138121919e"></script><script src="/wp-content/themes/tienda/static/js/main.chunk.js?e43d2e92c0138121919e"></script></body>
</html>
